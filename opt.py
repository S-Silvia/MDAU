...
def get_opt():
    ...
    parser.add_argument('--root', default='/media/cs4007/DATA/syy/try/model/', help='path to project')
    parser.add_argument('--image_root', default='/media/cs4007/DATA/syy/try/model/data/', type=str, metavar='PATH',
    ...
    parser.add_argument('--calibrated_stacking', type=float, default=True,
